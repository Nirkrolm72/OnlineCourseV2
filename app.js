...
const { isFormateur } = require('./api/middlewares/formateur.middleware');
...
const { getUsers } = require('./api/controllers/userControllers');
...
app.use('/formateur', isFormateur, formateur_routes);
...
app.get('/user', user_routes, getUsers);
